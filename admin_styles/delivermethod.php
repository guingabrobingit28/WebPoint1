    ...
    <div class="content">
        ...
        <div class="container-fluid pt-0 px-4">
            <div class="row vh-120 sidebarGraColor rounded align-items-center justify-content-between mx-0">
                ...
                <div class="col-xl-10">
                <h3 class="mb-4"><b></b>Add Deliver Method</b></h3>
                <h5>Delivery Method Name</h5>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingText" name="deliverName" placeholder="Delivery Method Name" required>
                    </div>
                </div>
                <div class="col-xl-10">
                    <button type="submit" class="btn btn-primary rounded-pill m-2" name="saveDeliver">add</button>
