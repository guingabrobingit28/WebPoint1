    ...
    <div class="content">
        ...
        <div class="container-fluid pt-0 px-4">
            <div class="row vh-120 sidebarGraColor rounded align-items-center justify-content-between mx-0">
                <form action="./php/insertData.php" method="post" id="subcategory" name="subcategory">
                <div class="col-xl-10">
                <h3 class="mb-4"><b></b>Add Municipality</b></h3>
                </div>
                <div class="col-xl-10">
                    <h5 class="mb-3">Municipality Name</h5>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingText" placeholder="Enter SubCategory Name" id="subcategory" name="subcategory" required>
                    </div>
                </div>
                <div class="col-xl-10">
                    <h5 class="mb-3">Deliver Price</h5>
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="floatingText" placeholder="Municipality" id="municipality" name="municipality" required>
                    </div>
                </div>
                <div class="col-xl-10">
                    <?php
                    ...
                    ?>
                    <h5 class="mb-3">Under of Category</h5>
                ...
                <div class="col-xl-10">
                    <button type="submit" id="save2" name="save2" class="btn btn-primary rounded-pill m-2">Submit</button>
