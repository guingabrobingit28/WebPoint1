    ...
    <div class="content">
        ...
        <div class="container-fluid pt-0 px-4">
            <div class="row vh-120 sidebarGraColor rounded align-items-center justify-content-between mx-0">
                <form action="./php/insertData.php" method="post" id="product" name="product" enctype="multipart/form-data">
                <div class="col-xl-10">
                <h3 class="mb-4"><b></b>Add Product</b></h3>
                <div class="mb-3">
                    <label for="formFile" class="form-label"><b>Product Image</b></label>
                    <input class="imgfile bg-transparent" type="file" id="formFile" name="imagefile" required>
                </div>
                </div>
                <div class="col-xl-10">
                ...
                <div class="col-xl-10">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" name="price" id="floatingText" placeholder="Price" required>
                    </div>
                </div>
                <div class="col-xl-10">
                    <h5 class="mb-3">Quantity</h5>
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" name="quantity" id="floatingText" placeholder="Quantity" required>
                    </div>
                </div>
                <div class="col-xl-10">
                    <h5 class="mb-3">Critical Value</h5>
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" name="criticalValue" id="floatingText" placeholder="Critical Value" required>
                    </div>
                </div>
                <div class="col-xl-10">
                    ...
                    ?>
                    <select class="form-select mb-3 " name="category" id="category" aria-label=".form-select-sm example">
                ...
                <div class="col-xl-10">
                    ...
                    <?php
                        // Retrieve the list of categories from the database
                        $supplier_query = "SELECT Supplier_id, Supplier_name FROM tblsupplierinfo";
                    ...
                    <select class="form-select mb-3" name="supplierid" aria-label=".form-select-sm example">
                        ...
                        <option value="<?php echo $supplier_row['Supplier_id']?>"><?php echo $supplier_row['Supplier_name']?></option>
                        <?php endwhile; ?>
                    </select>
                </div>
                <div class="col-xl-10">
                ...
                <div class="col-xl-10">
                    <button type="submit" name="save" value="Upload" class="btn btn-primary rounded-pill m-2">Save</button>
                    <button type="submit" class="btn btn-primary rounded-pill m-2" onclick="cancel()">Cancel</button>
                </div>
                </form>
            </div>
        </div>
