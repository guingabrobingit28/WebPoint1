    ...
    <div class="content">
        ...
        <div class="container-fluid pt-0 px-4">
            <div class="row vh-120 sidebarGraColor rounded align-items-center justify-content-between mx-0">
                ...
                <div class="col-xl-10">
                    <h3 class="mb-4"><b></b>Add Province</b></h3>
                </div>
                <div class="col-xl-10">
                    <h5 class="mb-3">Province Name</h5>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingText" placeholder="Province" id="province" name="province"  required>
                        
                    </div>
                </div>
                <div class="col-xl-10">
                    <button type="submit" id="saveProvince" name="saveProvince" value="Upload" class="btn btn-primary rounded-pill m-2">Save</button>
