    ...
    <div class="content">
        ...
        <div class="container-fluid pt-0 px-4">
            <div class="row vh-120 sidebarGraColor rounded align-items-center justify-content-between mx-0">
                ...
                <div class="col-xl-10">
                <h3 class="mb-4"><b></b>Add Track Status</b></h3>
                </div>
                <div class="col-xl-10">
                    <h5 class="mb-3">Track Status Name</h5>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingText" id="trackStatusName" name="trackStatusName" required>
                        <label for="floatingText">Enter Track Status</label>
                    </div>
                </div>
                <div class="col-xl-10">
                    <button type="submit" id="saveService" name="saveTrackStatus" class="btn btn-primary rounded-pill m-2">Submit</button>
