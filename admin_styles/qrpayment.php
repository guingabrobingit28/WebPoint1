    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar sidebarGraColor navbar-dark">
            ...
            <div class="navbar-nav w-100">
                <a href="indashboarddex.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
    ...
    <div class="content">
        ...
        <div class="container-fluid pt-0 px-4">
            <div class="row vh-120 sidebarGraColor rounded align-items-center justify-content-between mx-0">
                <form action="./php/insertData.php" method="post" id="category" name="category" enctype="multipart/form-data">
                <div class="col-xl-10">
                <h3 class="mb-4"><b></b>Add QRcode Payment</b></h3>
                <div class="mb-3">
                    <label for="formFile" class="form-label"><b>QRcode Image</b></label>
                    <input class="imgfile bg-transparent" type="file" id="imageqr" name="imageqr">
                </div>
                </div>
                <div class="col-xl-10">
                    <h5 class="mb-3">QRcode Name</h5>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingText" placeholder="Qrcode Name" id="qrname" name="qrname"  required>
                    </div>
                </div>
                <div class="col-xl-10">
                    <button type="submit" id="save4" name="saveQr" value="Upload" class="btn btn-primary rounded-pill m-2">Save</button>
