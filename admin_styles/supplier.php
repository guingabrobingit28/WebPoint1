    ...
    <div class="content">
        ...
        <div class="container-fluid pt-0 px-4">
            <div class="row vh-120 sidebarGraColor rounded align-items-center justify-content-between mx-0">
                ...
                <div class="col-xl-10">
                <h3 class="mb-4"><b></b>Add Supplier Information</b></h3>
                <h5>Supplier Name</h5>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingText" name="supplierName" placeholder="Supplier Name" required>
                    </div>
                </div>
                <div class="col-xl-10">
                    <h5 class="mb-3">Contact Number</h5>
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="floatingText" placeholder="Contact Number" id="contactNumber" name="contactNumber" required>
                    </div>
                </div>
                <div class="col-xl-10">          
                    <input type="number" class="form-control hidden" id="floatingText" id="address_id" name="address_id">  
                </div>
                <div class="col-xl-10">
                    <button type="submit" class="btn btn-primary rounded-pill m-2" name="saveSupp">add</button>
