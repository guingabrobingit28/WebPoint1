    ...
    <div class="content">
        ...
        <div class="container-fluid pt-0 px-4">
            <div class="row vh-120 sidebarGraColor rounded align-items-center justify-content-between mx-0">
                ...
                <div class="col-xl-10">
                <h3 class="mb-4"><b></b>Add Services</b></h3>
                </div>
                <div class="col-xl-10">
                    <h5 class="mb-3">Sevice Name</h5>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingText" id="serviceName" name="serviceName" required>
                        <label for="floatingText">Enter Services</label>
                    </div>
                </div>
                <div class="col-xl-10">
                    <h5 class="mb-3">Sevice Price</h5>
                    <div class="form-floating mb-3">
                        <input type="Number" class="form-control" id="floatingText" id="servicePrice" name="servicePrice" required>
                        <label for="floatingText">Enter Services Price</label>
                    </div>
                </div>
                <div class="col-xl-10">
                    <button type="submit" id="saveService" name="saveService" class="btn btn-primary rounded-pill m-2">Submit</button>
