...
function addProduct($conn){
    ...
    if(getimagesize($_FILES['imagefile']['tmp_name']) == false) {
        ...
        if(isset($_FILES['imagefile'])) {
            ...
            $sqlinsert = "INSERT INTO tblproductinfo (product_name, product_price, product_status_id, img_path, supplier_id, category_id, quantity, critical_value, description) 
                          VALUES ('$productname', $price, $status, '{$target_file2}', $supplierid, $category, $quantity, $criticalValue,'$description')";
