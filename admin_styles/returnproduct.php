    ...
    <div class="content">
        ...
        <div class="container-fluid pt-0 px-4">
            <div class="row vh-120 sidebarGraColor rounded align-items-center justify-content-between mx-0">
                ...
                <div class="col-xl-10">
                <h3 class="mb-4"><b></b>Add Returned Product</b></h3>
                    <div class="mb-3">
                        <label for="formFile" class="form-label"><b>Proof Product Image</b></label>
                        <input class="imgfile bg-transparent" type="file" id="formFile" name="imagefile" required>
                    </div>
                </div>
                <div class="col-xl-10">
                    <h5 class="mb-3">Order no.</h5>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingText" name="orderNumber" placeholder="Order number" required>
                    </div>
                </div>
                <div class="col-xl-10">
                ...
                <div class="col-xl-10">
                    <h5 class="mb-3">Return Statement</h5>
                    <div class="form-floating mb-3">
                        <textarea class="form-control" name="returnStatement" id="floatingText" cols="30" rows="10" style="height:100%;"></textarea>
                    </div>
                </div>
                <div class="col-xl-10">
                    <button type="submit" name="saveReturn" value="Upload" class="btn btn-primary rounded-pill m-2">Save</button>
                    <button type="submit" class="btn btn-primary rounded-pill m-2">Cancel</button>
                </div>
                </form>
            </div>
        </div>
