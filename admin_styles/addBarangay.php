    ...
    <div class="content">
        ...
        <div class="container-fluid pt-0 px-4">
            <div class="row vh-120 sidebarGraColor rounded align-items-center justify-content-between mx-0">
                ...
                <div class="col-xl-10">
                <h3 class="mb-4"><b></b>Add Barangay</b></h3>
                </div>
                <div class="col-xl-10">
                    <h5 class="mb-3">Barangay Name</h5>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingText" placeholder="Barangay" id="barangay" name="barangay" required>
                    </div>
                </div>
                <div class="col-xl-10">
                    <?php
