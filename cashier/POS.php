...
// $query = "select * from tbluseraccount where User_Position_id  = 2 limit 1";
                    ...
                    <div class="search">
                        ...
                        <div class="scrollBar">
                            ...
                            <?php foreach ($products as $product) { ?>
                              ...
                              $absolutePath = 'http://localhost/WebPoint1/admin_styles/' . $path;
                            //   if (!$absolutePath || !file_exists($absolutePath)) {
                            //     echo "Error: could not find file at path $absolutePath";
                            // } else {
                            //     echo "The file is located at: " . $absolutePath;
                            // }
                            ...
                            ?>
                                ...
                                <input type="number" class="hidden" name="product_id[]" value="<?php echo $product['product_id']; ?>">
                                    <div class="img">
                                        <img src="<?php echo $absolutePath; ?>" alt="">
...
// paymentMethodButtons.forEach(button => {
//   button.addEventListener('click', () => {
//     // Check if the button's value is 2 or 3
//     if (button.value === '2' || button.value === '3') {
//       // Prompt the user to enter the admin password
//       //const username = prompt('Please enter the admin password:');
//       const password = prompt('Please enter the admin password:');
//       const formData = new FormData();
//       formData.append('password', password);
//       if (formData.has('password')) {
//   console.log('Password data found in FormData');
// } else {
//   console.log('Password data not found in FormData');
// }
//       console.log(formData.get('password'));
//       console.log(formData);
//       // Send the admin password to the server to verify
//       $.ajax({
...
//             // If the admin password is correct, enable the button
//             button.classList.add('active');
//           } else {
...
//       });
//     } else {
//       // For buttons with other values, enable the button directly
//       button.classList.add('active');
//     }
        ...
        preConfirm: (password) => {
          ...
          return $.ajax({
            ...
            if (response.success === true) {
              ...
              Swal.fire({
              icon: 'success',
              title: 'Admin password is correct!',
              ...
              Swal.fire({
              icon: 'error',
              title: 'Incorrect admin password. Please try again.',
              showConfirmButton: false,
              timer: 1500
            });
            }
